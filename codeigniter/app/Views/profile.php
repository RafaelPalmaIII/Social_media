...
<head>
    ...
    *:focus {
    ...
    header {
        background-color: rgba(30, 30, 30, 1); /* Dark header background */
        padding: .4rem 0 0;
    }
    ...
    section {
        ...
        background-color: rgba(30, 30, 30, 1); /* Dark section background */
    }
    ...
    section pre {
        background-color: rgba(40, 40, 40, 1); /* Dark code block background */
        border: 1px solid rgba(64, 64, 64, 1); /* Dark border */
        color: rgba(255, 255, 255, 1); /* Light code text color */
        display: block;
        font-size: .9rem;
        margin: 2rem 0;
        padding: 1rem 1.5rem;
    ...
    section a {
        color: rgba(221, 72, 20, 1); /* Highlighted link color */
    }
    ...
    .svg-stroke {
        fill: none;
        stroke: #fff; /* Light stroke color for SVGs */
        stroke-width: 32px;
    }

    footer {
        background-color: rgba(30, 30, 30, 1); /* Dark footer background */
        text-align: center;
        padding: calc(2rem - 10mm) 1.75rem; /* Reduced height by 10mm */
    }

    footer .environment {
        color: rgba(255, 255, 255, 1); /* Light footer text color */
    }

    footer .copyrights {
        background-color: rgba(40, 40, 40, 1); /* Slightly darker footer section */
        color: rgba(200, 200, 200, 1); /* Light gray text color */
