...
html, body {
    color: rgba(255, 255, 255, 1); /* Light text color */
...
header ul {
    border-bottom: 1px solid rgba(64, 64, 64, 1); /* Dark border */
...
header li a {
    border-radius: 5px;
    color: rgba(255, 255, 255, .7); /* Light text color */
    display: block;
    height: 44px;
...
section pre {
    background-color: rgba(40, 40, 40, 1); /* Dark background for code block */
    border: 1px solid rgba(64, 64, 64, 1); /* Dark border */
    display: block;
    font-size: .9rem;
    margin: 2rem 0;
    padding: 1rem 1.5rem;
    ...
    color: rgba(255, 255, 255, 1); /* Light text color for code */
}
...
section a {
    color: rgba(221, 72, 20, 1); /* Light orange color for links */
}
...
.further {
    background-color: rgba(40, 40, 40, 1); /* Dark background for further section */
    border-bottom: 1px solid rgba(64, 64, 64, 1); /* Dark border */
...
.svg-stroke {
    fill: none;
    stroke: #fff; /* Light stroke for SVGs */
    stroke-width: 32px;
}
...
.form-container {
    ...
    background-color: rgba(40, 40, 40, 1); /* Dark background for the container */
...
.form-container form button {
    width: 100%; /* Ensure elements take up full width of container */
    max-width: 100%; /* Adjust width within container */
    display: block;
}

footer {
    background-color: rgba(40, 40, 40, 1); /* Dark background for footer */
    text-align: center;
}
...
footer .copyrights {
    background-color: rgba(62, 62, 62, 1); /* Dark background for copyrights section */
...
@media (max-width: 629px) {
    ...
    header .menu-item {
        background-color: rgba(40, 40, 40, 1); /* Dark background for small screens */
        border-top: 1px solid rgba(64, 64, 64, 1); /* Dark border */
        margin: 0 15px;
        width: calc(100% - 30px);
    }
