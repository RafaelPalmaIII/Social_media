...
<head>
    ...
    *:focus {
    ...
    html, body {
        ...
        margin: 0;
        padding: 0;
        color: rgba(255, 255, 255, 1); /* White text for dark mode */
        ...
        flex-direction: column; /* Ensures header, content, and footer stack vertically */
    }

    header {
        background-color: rgba(50, 50, 50, 1); /* Darker red for dark mode */
        padding: 1rem 2rem;
        ...
        left: 0;
        z-index: 1000;
        height: 80px; /* Medium fixed size for the header */
    }
    ...
    .submit-btn {
        background-color: rgba(221, 72, 20, 1); /* Dark Red Button */
        color: #fff;
        padding: 12px 24px;
        border: none;
        border-radius: 8px;
    ...
    .submit-btn:hover {
        background-color: rgba(221, 72, 20, .8); /* Darker shade on hover */
    }

    .section {
    background-color: rgba(40, 40, 40, .9); /* Darker background for section */
    padding: 20px;
    margin: 20px;
    border-radius: 10px;
    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3);
    width: 100%;
    max-width: 728px; /* Increased max-width by roughly 100px for a larger container */
    margin-top: 120px; /* Space to avoid overlap with the fixed header */
    margin-bottom: 100px; /* Space to avoid overlap with the fixed footer */
}
    ...
    .input-field {
    width: calc(100% - 298px); /* Reduced width by 10mm (38px) */
    padding: 20px;
    margin: 15px 0;
    ...
    footer {
        background-color: rgba(50, 50, 50, 1); /* Dark footer background */
        text-align: center;
        padding: 20px;
        color: #fff;
        ...
        left: 0;
        width: 100%; /* Full width */
        height: 80px; /* Medium fixed size for the footer */
    }
